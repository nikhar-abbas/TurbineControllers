...
REAL(4), PARAMETER           :: VS_RtPwr      =   5102040.82                    ! Rated generator power in Region 3, Watts. -- chosen to be 5MW divided by the electrical generator efficiency of 94.4%
...
IF ( iStatus == 0 )  THEN  ! .TRUE. if we're on the first call to the DLL
   ...
   ErrMsg   = 'Running with torque and pitch control of the NREL Baseline '// &
              ...
              'Sowento energy. The controller has been tuned by Pietro Bortolotti ' // &
