...
REAL(4), PARAMETER           :: KpFlap        = -0.00002                           ! Gain for proportional flap controller
REAL(4), PARAMETER           :: MyTarget      = VS_RtPwr                      ! Rated Power target value for flap control
...
!=======================================================================
   ...
   BlFlap(1) = KpFlap*(avrSWAP(15)-MyTarget)
   BlFlap(2) = KpFlap*(avrSWAP(15)-MyTarget)
   BlFlap(3) = KpFlap*(avrSWAP(15)-MyTarget)
