...
REAL(4), PARAMETER           :: CornerFreq_HSS    =   0.25                      ! Corner frequency (-3dB point) in the recursive, single-pole, low-pass filter, rad/s. -- !! NJA: Not yet: chosen to be 1/4 the blade edgewise natural frequency ( 1/4 of approx. 1Hz = 0.25Hz = 1.570796rad/s)
...
REAL(4), PARAMETER           :: VS_MaxRat     =   1500000                      ! Maximum torque rate (in absolute value) in torque controller, N-m/s.
REAL(4), PARAMETER           :: VS_MaxTq      =   90771.92                      ! Maximum generator torque in Region 3 (HSS side), N-m. -- chosen to be 10% above VS_RtTq      = 000000.0 = 43.09355kNm
Real(4), PARAMETER           :: VS_RtTq       =   82519.45                      ! Rated generator torque, Nm.
REAL(4), PARAMETER           :: VS_Rgn2K      =     17.48594                    ! Generator torque constant in Region 2 (HSS side), N-m/(rad/s)^2.
...
REAL(4), PARAMETER           :: VS_RtGnSp     =     64.1862                     ! Rated generator speed (HSS side), rad/s. -- chosen to be 100% of PC_RefSpd
