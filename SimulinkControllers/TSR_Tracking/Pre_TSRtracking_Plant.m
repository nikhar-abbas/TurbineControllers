...
Avec_pc = A(Bop_pc(1):end);
Bbvec_pc = Bb(Bop_pc(1):end);
Betaop_pc = Beta_op(Bop_pc(1):end);
vv_bpc = vv(Bop_pc(1):end);
...
Kp_pc = 1./Bbvec_pc .* (2*PC_zeta*PC_om_n + Avec_pc);
Ki_pc = PC_om_n^2./Bbvec_pc ;
