...
param.HSSfilt_omn           = 4.519 * 1/4;    % Corner frequency in the recursive, second order low pass filter of the HSS Speed, Hz. -- Chosen to be 1/4 of the first drivetrain natural frequency
param.WindSpeedEstfilt_omn  = .25;            % Corner frequency for Wind Speed Filt, Hz. -- (Currently arbitrary)
...
param.VS_om_n = 1/(3*6.25);                 % Natural frequency, Hz. -- Time constant chosen to be on third the rotor frequency at rated. 

% Blade Pitch Controller Parameters
param.PC_zeta = 0.7;                         % Damping constant, --
param.PC_om_n = 0.25;                         % Natural frequency, Hz.

% Region 2.5 Gain Bias
param.VS_GainBias = 0.5; 0.031;              % VS Controller Bias Gian for Region 2.5 smoothing, -.
param.PC_GainBias = 0.05; 0.81;              % Pitch Controller Bias Gian for Region 2.5 smoothing, -.
