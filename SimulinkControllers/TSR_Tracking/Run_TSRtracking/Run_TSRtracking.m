...
% Pre_FastMod([ModDir fileopen . sep ServoFile], servoparams, {5,5,0,0});
...
[Filt.Wind.b,Filt.Wind.a] = filt_2lp_D(ContParam.WindSpeedEstfilt_omn,1,dt); 
[Filt.GBFilt.b,Filt.GBFilt.a] = filt_1lp_D(ContParam.GBfilt_omn,dt); 
