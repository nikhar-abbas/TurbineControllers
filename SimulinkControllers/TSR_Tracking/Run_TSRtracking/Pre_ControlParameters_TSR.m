...
param.HSSfilt_omn           = 4.519 * 3/4;    % Corner frequency in the recursive, second order low pass filter of the HSS Speed, Hz. -- Chosen to be 3/4 of the first drivetrain natural frequency
...
param.VS_om_n = 0.4; 1/(2*6.25);                 % Natural frequency, Hz. -- Time constant chosen to be on third the rotor frequency at rated. 
...
param.VS_GainBias = 0.5; 0.31; 0.031;              % VS Controller Bias Gian for Region 2.5 smoothing, -.
